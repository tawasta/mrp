...
[material_requirement_planning](material_requirement_planning/) | 14.0.1.0.0 |  | Material Requirement
...
[mrp_bom_structure_xlsx_recursive](mrp_bom_structure_xlsx_recursive/) | 14.0.1.0.1 |  | Field additions for the BOM export module
...
[mrp_multi_level_create_parameter_from_so_bom_recursive](mrp_multi_level_create_parameter_from_so_bom_recursive/) | 14.0.1.0.1 |  | Sale order line product BoM is run through recursively
