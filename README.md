...
[mrp_area_mrp_move_customer_name](mrp_area_mrp_move_customer_name/) | 14.0.1.0.0 |  | Adds customer name to MRP Profile
...
[mrp_multi_level_safety_stock_warning](mrp_multi_level_safety_stock_warning/) | 14.0.1.0.0 |  | Shows if more stock is needed based on safety stock and Qty on hand
