...
class MrpBom(models.Model):
    ...
    def iterate_children(self, top_bom_id, bom_lines):
        ...
        archived_product_line_model = self.env[
            "mrp_bom_archived_product_list.archived_product_line"
        ]
    ...
    archived_info_last_update = fields.Datetime(string="Archived info last updated",)
