...
class MrpBom(models.Model):
    ...
    def _get_op_cost(self):
        for bom in self:
            ...
            bom.op_cost =\
                sum([line.op_cost_total for line in bom.bom_line_ids])\
                +\
                sum([op.operation_cost for op in bom.routing_id.operation_ids])
    ...
    total_cost = fields.Float(
        ...
        string="Total Cost",
        help='''Component and operations costs combined for
                all parts and sub-assemblies''')
