...
class MrpBom(models.Model):
    ...
    def compute_raw_material_qties(self, 
        ...
        manufacture the product. Iterates through subassemblies and takes into
        account how many subassemblies are needed for the main assembly when 
        calculating their number of components needed '''
        self.ensure_one()
