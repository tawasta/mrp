...
class TestBom(TransactionCase):
    def setUp(self):
        ...
        self.main_assembly_1 = product_model.create(
            {"name": "Main assembly 1", "purchase_line_warn": "no-message"}
        )

        self.main_assembly_2 = product_model.create(
            {"name": "Main assembly 2", "purchase_line_warn": "no-message"}
        )

        self.subassembly_1 = product_model.create(
            {"name": "Sub-assembly 1", "purchase_line_warn": "no-message"}
        )

        self.subassembly_2 = product_model.create(
            {"name": "Sub-assembly 2", "purchase_line_warn": "no-message"}
        )

        self.subassembly_3 = product_model.create(
            {"name": "Sub-assembly 3", "purchase_line_warn": "no-message"}
        )

        self.component_1 = product_model.create(
            {"name": "Component 1", "purchase_line_warn": "no-message"}
        )

        self.component_2 = product_model.create(
            {"name": "Component 2", "purchase_line_warn": "no-message"}
        )

        self.component_3 = product_model.create(
            {"name": "Component 3", "purchase_line_warn": "no-message"}
        )
    ...
    def test_two_boms(self):
        ...
        recordset = self.env["mrp.bom"].browse(
            [main_assembly_1_bom_res.id, main_assembly_2_bom_res.id]
        )
